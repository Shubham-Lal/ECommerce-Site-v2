...
* [Profile Page](https://certystore-v2.pages.dev/profile)

* [Signup Page](https://certystore-v2.pages.dev/signup)

* [All Products Page](https://certystore-v2.pages.dev/products)

* [Product's Detail Page](https://certystore-v2.pages.dev/product/MacBook-Pro-M2)

* [Best Selling Products Page](https://certystore-v2.pages.dev/best-selling)

* [Events Page](https://certystore-v2.pages.dev/events)

* [FAQs Page](https://certystore-v2.pages.dev/faq)
